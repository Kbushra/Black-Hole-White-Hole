...
with (objRadioactive) { with (objMap) { draw_sprite_ext(sprRadioactiveM, 0, x + other.x*scaleX, y + other.y*scaleY, other.image_xscale*scaleX*32, other.image_yscale*scaleY*32, 0, c_white, 1); } }
...
with (objAsterDust) { with (objMap) { draw_sprite_ext(sprAsterM, 0, x + other.x*scaleX, y + other.y*scaleY, 1, 1, 0, c_white, 0.3); } }
